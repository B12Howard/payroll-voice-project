...
# DISABLED: Requires billingbudgets API to be enabled
# To enable: gcloud services enable billingbudgets.googleapis.com
#
...
variable "billing_account_id" {
  ...
  type        = string
  default     = ""  # Now optional since budget is disabled
}
